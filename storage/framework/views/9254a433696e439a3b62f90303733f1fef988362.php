                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1><span class="res-ds-n">Sale Payment</span></h1>
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-field="paid">Received</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="" class="btn btn-primary btn-add-sale-payment" data-id="<?php echo e($payment->id); ?>" style="color: #fff;"><i class="fa fa-plus"></i></a>
                                                                    </td>
                                                                </tr>
...
</html><?php /**PATH C:\wamp64\www\adnan\resources\views/payment/sale-payment.blade.php ENDPATH**/ ?>