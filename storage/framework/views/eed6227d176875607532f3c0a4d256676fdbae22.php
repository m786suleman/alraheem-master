    ...
    <main>
      ...
      <table border="1" cellspacing="0" cellpadding="0">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td class="qty" style="text-align: center;"><?php echo e($item->discount); ?> %</td>
              <td class="qty" style="text-align: center;"><?php echo e($item->new_price); ?></td>
        ...
        <tfoot>
          ...
          <?php endif; ?>
          <tr>
            <td colspan="4"><b>Original Price</b></td>
            <td><b><?php echo e($price); ?></b></td>
          </tr>
          <tr>
            <td colspan="4">Total Books</td>
            <td><?php echo e($books); ?></td>
          </tr>
          ...
          <tr>
            ...
            <td><b><?php echo e($sales->receivable); ?></b></td>
          </tr>
          <tr>
            <?php if($sales->payment_method == 'credit'): ?>
              <td colspan="4">Due</td>
              <td><?php echo e(str_replace("-", "", $sales->remaining)); ?></td>
            <?php elseif($sales->receivable > $sales->received): ?>
              <td colspan="4">Due</td>
              <td><?php echo e($sales->remaining); ?></td>
            <?php else: ?>
...
</html><?php /**PATH /var/www/html/adnan/resources/views/print/sale-print-english.blade.php ENDPATH**/ ?>