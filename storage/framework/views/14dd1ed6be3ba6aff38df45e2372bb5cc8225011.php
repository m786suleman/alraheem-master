                ...
                <div class="col-lg-6 col-md-1 col-sm-1 col-xs-12">
                    <div class="header-top-menu tabl-d-n">
                        <ul class="nav navbar-nav mai-top-nav">
                            ...
                            <li class="nav-item"><a href="<?php echo e(route('sales.new-sale')); ?>" target="_blank" class="nav-link">New Invoice</a>
                            </li>
                            <li class="nav-item"><a href="<?php echo e(route('sales.transfer-sale')); ?>" target="_blank" class="nav-link">New Purchase</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
</div><?php /**PATH C:\wamp64\www\usmanakram\resources\views/layout/header-top-area.blade.php ENDPATH**/ ?>