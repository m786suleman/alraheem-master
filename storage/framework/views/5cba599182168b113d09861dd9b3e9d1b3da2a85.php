                                ...
                                <div class="sparkline7-list">
                                        ...
                                        <div class="main-spark7-hd">
                                            ...
                                            <div class="sparkline7-outline-icon" style="margin-top: -5px;">
                                                <span class="sparkline7-collapse-link">
                                                    <a href="<?php echo e(route('reports.sale.print-all-english')); ?>" class="btn btn-primary btn-printAllPurchaseReportEnglish"><i class="fa fa-print"></i></a>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sparkline7-graph">
                                        ...
                                        <div class="row" style="text-align: left;" id="brandSection">
                                            <form action="<?php echo e(route('reports.search-sale-by-brand')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                        ...
                                        <div class="row" style="text-align: left;" id="dateSection">
                                            <form action="<?php echo e(route('reports.search-sale')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                            ...
                                                            <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="<?php echo e(route('sales-list-print-english', ['id' => $sale->id])); ?>" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i></a>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </tbody>
...
<?php /**PATH C:\wamp64\www\adnan\resources\views/reports/sales/sale-report.blade.php ENDPATH**/ ?>