...
<nav id="sidebar">
    ...
    <div class="left-custom-menu-adp-wrap">
        <ul class="nav navbar-nav left-sidebar-menu-pro">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('sub-categories')); ?>" class="nav-link dropdown-toggle"><i class="fa big-icon fa-list"></i> <span class="mini-dn">Sub-Categories</span></a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(route('brands')); ?>" class="nav-link dropdown-toggle"><i class="fa big-icon fa-list"></i> <span class="mini-dn">Brands</span></a>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-shopping-basket"></i> <span class="mini-dn">Purchase</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                    <a href="<?php echo e(route('purchase.purchase-form')); ?>" class="dropdown-item">Purchase Items</a>
            ...
            <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-shopping-cart"></i> <span class="mini-dn">Payments</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                    <a href="<?php echo e(route('payment.purchase-payment')); ?>" class="dropdown-item">Purchase Payment</a>
                    <a href="<?php echo e(route('payment.sale-payment')); ?>" class="dropdown-item">Sale Payment</a>
...
</nav><?php /**PATH C:\wamp64\www\adnan\resources\views/layout/left-sidebar.blade.php ENDPATH**/ ?>