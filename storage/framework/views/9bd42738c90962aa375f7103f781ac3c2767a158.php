                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="income-dashone-total user-monthly shadow-reset nt-mg-b-30">
                                    <div class="income-title">
                                        <div class="main-income-head">
                                            <h2>Today Supply Rate</h2>
                                        </div>
                                    </div>
                                    <div class="income-dashone-pro">
                                        <form action="<?php echo e(route('update-today-price')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-lg-9">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" value="200" name="todayPrice" autofocus>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
...
</html><?php /**PATH C:\xampp\htdocs\alraheem-master\resources\views/dashboard/dashboard.blade.php ENDPATH**/ ?>