                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Sale Orders</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="sparkline7-list">
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            <h1><span class="res-ds-n">Sale Orders</span></h1>
                                            <div class="sparkline7-outline-icon">
                                                <span><a href="<?php echo e(route('order.sale-order-form')); ?>" style="margin-top:-5px;" class="btn btn-primary">New Order</a></span>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="<?php echo e(route('sale.sale-detail', ['id'=>$order->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
...
</html><?php /**PATH C:\wamp64\www\alraheem\resources\views/order/sale-orders.blade.php ENDPATH**/ ?>