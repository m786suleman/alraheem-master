                                ...
                                <div class="income-dashone-pro">
                                    <form action="<?php echo e(route('update-user-profile')); ?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <img src="<?php echo e(asset('public/users/').'/'.$user->logo); ?>" alt="" style="width: 170px;">
                                                    <?php if($user->logo): ?> 
                                        ...
                                        <div class="row">
                                          <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-6">
                                              ...
                                              <textarea name="address" id="address" name="address" cols="100" rows="3" class="form-control"><?php echo e($user->address); ?></textarea>
                                            </div>
                                        </div>
...
</html><?php /**PATH /var/www/html/adnan/resources/views/dashboard/profile.blade.php ENDPATH**/ ?>