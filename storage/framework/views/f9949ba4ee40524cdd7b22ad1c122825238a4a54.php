                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" tabindex="9" class="form-control" name="purchase_rate" id="purchase_rate" value="<?php echo e(old('purchase_rate')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="sale_rate">Sale Rate</label>
                                                    <input type="text" tabindex="9" class="form-control" name="sale_rate" id="sale_rate" value="<?php echo e(old('sale_rate')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
...
</html><?php /**PATH C:\xampp\htdocs\alraheem-master\resources\views/item/add-new-item.blade.php ENDPATH**/ ?>