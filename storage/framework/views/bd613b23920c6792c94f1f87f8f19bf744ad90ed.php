                        ...
                        <div class="col-lg-12">
                            <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    ...
                                    <form method="POST">
                                        <div class="row">
                                            <div class="col-lg-5" id="show-vendors-section">

                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label for="add_new_vendor">Add New&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                    <button type="button" id="add_new_vendor" class="btn btn-primary" data-toggle="modal" data-target="#myModalVendor"><i class="fa fa-plus"></i> Add new Customer</button>
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    <label for="sku">Lot#</label> 
                                                    <input type="number" tabindex="1" class="form-control" name="sku" id="sku">
                                                </div>
                                            </div>
                                            
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    <label for="item-discount-check">Check&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                    <input type="checkbox" name="item_discount_check" id="item-discount-check">
                                                </div>
                                            </div>
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                        ...
                                        <div class="row" style="margin-bottom: 10px;">
                                            <div class="col-lg-12">
                                                <table id="table1" class="focusguard-2" tabindex="4" data-toggle="table" data-pagination="false" data-search="false" data-show-columns="false" data-resizable="false" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="false">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="total price">Total</th>
                                                        </tr>
                                                    </thead>
                                                ...
                                                <div class="row" style="margin-top: 20px;">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            <label for="remaining">Return</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <input type="radio" id="fix-discount" name="discount_type" value="fix">
                                                        <label for="fix-discount">Fix Discount</label>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label for="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.get('<?php echo e(route("sale.get-session-items")); ?>', function(data){
                ...
                document.querySelector("#receivable").value = parseInt(total) + parseInt($("#previous_due").val());
            });
            ...
            $('#btn-add-in-list').click(function(e){
                ...
                if($('#item-discount-check').prop("checked") == true){
                    var price = $("#price").val();
                    var discount = $("#item-discount").val();
                    var new_price = $("#new-price").val();
                }
                else if($('#item-discount-check').prop("checked") == false){
                    var price = $("#price").val();
                    var discount = 0;
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $("#item-discount").val("0");
                        $("#new-price").val("0");
                        $("#item-discount-check").attr('checked', false);
                        $('#session-items').empty().append(data);
                        var total = $('#total').attr("data-id");
                        document.querySelector("#total_bill").value = (total);
                        document.querySelector("#receivable").value = parseInt(total) + parseInt($("#previous_due").val());
            ...
            $(".btn-retrieve").on('click', function(e){
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('sales.get-item-from-hold-session')); ?>",
                    data: {
                        },
                    success: function(data){
                        $('#show-hold-retrieve-body').empty().append(data);
                    },
                    error: function(data){
                        alert("Error in Retrieving Items");
                    }
                });
            });

            // Get Retrieve in list
            $("#show-hold-retrieve-body").on('click', '.hold-retrieve-btn', function(e){
                e.preventDefault();
                var id = $(this).attr('data-id');
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('sales.get-item-from-hold-into-list')); ?>",
                    data: {
                        id:id
                        },
                    success: function(data){
                        $("#holdRetrieveModal").modal('hide');
                        $("#item").select2('val', ' ');
                        $("#quantity").val("1");
                        $("#price").val("0");
                        $('#session-items').empty().append(data);
            ...
            $(document).on('change keyup blur', '#discount', function(){
                ...
                if(type == 'perc'){
                    ...
                    var dec = (disc / 100); //its convert 10 into 0.10
                    var mult = main * dec; // gives the value for subtract from main value
                    var discont = (main - mult) + parseInt(due);
            ...
            $(".btn-submit").click(function (e) {
                ...
                // if(customer == 'abc'){
                //     if(parseInt(received) < parseInt(receivable)){
                //         alert('This is not a Regular Customer. Please Collect Full Payment');
                //         return;
                //     }
                // }
                $.ajax({
...
</html><?php /**PATH C:\wamp64\www\adnan\resources\views/sales/new-sale.blade.php ENDPATH**/ ?>