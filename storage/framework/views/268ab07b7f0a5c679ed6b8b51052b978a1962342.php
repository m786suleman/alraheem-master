                                                            ...
                                                            <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                  ...
                                                                  <?php endif; ?>
                                                                    ...
                                                                    <td>
                                                                      <a href="<?php echo e(route('sale.sale-return-detail', ['id'=>$sale->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                      <a href="<?php echo e(route('sale.sale-delete', ['id'=>$sale->id])); ?>" class="btn btn-primary" style="color: #fff;"><i class="fa fa-trash"></i></a>
                                                                      
                                                                      <a href="<?php echo e(route('sales-return-list-print-english', ['id' => $sale->id])); ?>" class="btn btn-primary btn-print" style="color: #fff;"><i class="fa fa-print"></i> Eng</a>
                                                                    </td>
                                                                </tr>
...
</html><?php /**PATH C:\wamp64\www\abdulrehman\resources\views/sales/sales-return-list.blade.php ENDPATH**/ ?>