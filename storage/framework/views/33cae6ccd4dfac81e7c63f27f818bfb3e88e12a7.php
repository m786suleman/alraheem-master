                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" tabindex="9" class="form-control" name="description" id="description" value="<?php echo e(old('description')); ?>" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-5">
                                                <div class="form-group">
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-field="Brand">Weight</th>
                                                                
                                                                <th data-field="sku">Lot#</th>
...
</html><?php /**PATH C:\wamp64\www\adnan\resources\views/item/add-new-item.blade.php ENDPATH**/ ?>