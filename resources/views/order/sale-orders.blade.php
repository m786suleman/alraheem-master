                                    ...
                                    <div class="sparkline7-hd">
                                        <div class="main-spark7-hd">
                                            ...
                                            <div class="sparkline7-outline-icon">
                                                <span><a href="{{ route('order.sale-order-form') }}" style="margin-top:-5px;" class="btn btn-primary">New Order</a></span>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <tbody>
                                                            @foreach ($orders as $order)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                      <a href="{{ route('sale.sale-detail', ['id'=>$order->id]) }}" class="btn btn-primary" style="color: #fff;"><i class="fa fa-eye"></i></a>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
