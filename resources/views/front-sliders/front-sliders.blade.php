...
<head>
    ...
    <link href="{{asset('public/file-upload/file-upload-with-preview.min.css')}}" rel="stylesheet" type="text/css" />
</head>
...
<body class="materialdesign">
                                                    ...
                                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-resizable="true" data-cookie="true" data-page-size="5" data-page-list="[5, 10, 15, 20, 25]" data-cookie-id-table="saveId" data-show-export="true">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @endphp
                                                                <tr>
                                                                    <td>{{ $index }}</td>
                                                                    <td style="text-align: center;"><img src="{{ asset('public/front/slider/').'/'.$slider->image }}" alt="" style="width:300px;"></td>
                                                                    <td>{{ $slider->type }}</td>
                                                                    <td>
    ...
    <script src="{{asset('public/file-upload/file-upload-with-preview.min.js')}}"></script>
    <script>
