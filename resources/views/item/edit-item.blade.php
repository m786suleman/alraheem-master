                                ...
                                <div class="income-dashone-pro">
                                    <form action="{{ route('item.update-item', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label for="english_name">Barcode</label>
                                                    {!! $item->barcode !!}
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label for="english_name">SKU</label>
                                                    <input type="text" class="form-control" value="{{ $item->sku }}" name="sku" id="sku">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    <label for="add_new_category">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                    <button type="button" id="add_new_category" class="btn btn-primary" data-toggle="modal" data-target="#myModalSubCategory">Add New</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="brand" id="brand" class="form-control">
                                                        <option value="brand a" <?php if($item->brand == 'brand a') echo "selected"; ?>>Brand A</option>
                                                        <option value="brand b" <?php if($item->brand == 'brand b') echo "selected"; ?>>Brand B</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" tabindex="9" class="form-control" value="{{ $item->description }}" name="description" id="description" value="{{ old('description') }}">
                                                </div>
                                            </div>
                                            <div class="col-lg-1">
                                                <div class="form-group">
                                                    ...
                                                    <select name="unit" id="unit" class="form-control">
                                                        <option value="{{ $item->unit }}" disabled selected>{{ $item->unit }}</option>
